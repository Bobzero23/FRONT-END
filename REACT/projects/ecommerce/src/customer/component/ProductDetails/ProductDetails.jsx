    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6 ">
                <div className="flex items-center">
                  ...
                  <p className="opacity-50 text-sm">3437 Ratings</p>
                  <p className="ml-3 text-sm font-sm text-indigo-800 hover:text-indigo-500">
                    459922 Reviews
                  </p>
                </div>
              </div>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">35345345 Ratings</p>
                </div>
        ...
        <section className="mt-10">
          <h1 className="font-semibold m-4">similar products</h1>
